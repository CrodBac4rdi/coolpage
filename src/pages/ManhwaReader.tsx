...
import { Book, Heart, Sparkles, Coffee, Moon, Sun, Star, ArrowLeft } from 'lucide-react'
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl">
                ...
                <div className="space-y-1">
                  <p className="text-xs text-gray-400">
                    Chapters Read: {currentChapter + 1}/{story.chapters.length}
                  </p>
                  <p className="text-xs text-gray-400">
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-bold flex items-center gap-3">
                  <span className="text-4xl">{story.chapters[currentChapter].emoji}</span>
