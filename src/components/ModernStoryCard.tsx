    ...
    >
      <Link to={`/reader/${id}`}>
        ...
        >
          {/* Glow effect */}
          <motion.div
            className={cn('absolute -inset-0.5 bg-gradient-to-r rounded-3xl blur opacity-0 group-hover:opacity-50 transition duration-1000', ...getGradient().split(' '))}
          ...
          <div className={`relative h-full bg-gradient-to-br from-gray-900/90 to-black/95 border border-white/20 rounded-3xl p-8 overflow-hidden backdrop-blur-sm`}>
            ...
            <div className={cn('absolute inset-0 bg-gradient-to-br opacity-10 rounded-3xl', ...getGradient().split(' '))} />
            ...
            <div className="relative mb-8">
              ...
              >
                {/* Gradient circle */}
                <div className={cn('absolute inset-0 rounded-full bg-gradient-to-br opacity-40 blur-xl', ...getGradient().split(' '))} />
            ...
            <h3 className="text-2xl font-bold text-white mb-3 text-center leading-tight relative">
              ...
              <motion.div
                className={cn('absolute -bottom-1 left-1/2 -translate-x-1/2 h-0.5 bg-gradient-to-r rounded-full', ...getGradient().split(' '))}
                initial={{ width: 0 }}
