...
export default function HeartCollector() {
  ...
  return (
    <div className="bg-gradient-to-br from-pink-900/20 to-purple-900/20 rounded-3xl p-6 backdrop-blur-xl border border-white/10">
      <h3 className="text-2xl font-bold mb-4 text-center">Heart Collector</h3>
      ...
      {/* Game Area */}
      <div className="relative h-[400px] bg-black/20 rounded-xl overflow-hidden cursor-none">
        {!gameActive && (
      ...
      <div className="mt-4 text-center text-sm text-gray-400">
        <p>Move your mouse to catch hearts! 💕</p>
        <p className="mt-1">
